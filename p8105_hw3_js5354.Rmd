...
```{r spaghetti plot, fig.width = 6, fig.height = 8}
...
ggplot(spaghetti_df, aes(x = year, y = n, color = locationabbr)) +
  ...
  labs(x = "Year", 
       y = "Num. of locations",
       title = "The number of locations in each state\nfrom 2002 to 2010") +
...
```{r load ny_noaa data, include = FALSE}
...
```{r distribution of snowfall values, fig.width = 6, fig.height = 6}
snowfall_plot = 
ny_noaa  %>% 
